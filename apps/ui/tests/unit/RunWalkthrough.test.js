...
describe("Run walkthrough", () => {
    it("T-R1 renders the seven stage pills with correct titles", async () => {
        renderRun();
        await waitFor(() => expect(screen.getByTestId("run-walkthrough")).toBeInTheDocument());
    ...
    it("T-R9 header shows verdict pill and merkle root short hash", async () => {
        ...
        expect(screen.getByText(/merkle_root · /)).toHaveTextContent("merkle_root · f1468f1b6765");
    });
