...
const runModules = import.meta.glob("@/mocks/fixtures/runs/*.json", { eager: true });
const runsById = new Map(Object.entries(runModules).map(([path, mod]) => {
...
export const handlers = [
    ...
    http.get(`${base}/api/v1/employees/:id/reviews/:period`, ({ params }) => {
